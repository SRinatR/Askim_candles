...
*   **Internationalization (i18n):**
    *   **Main Site:** Path-based (`/[locale]/...`) with UZ (default), RU, EN. Uses dictionary files in `src/dictionaries/`. Client components use local getters importing main dictionaries or receive dictionaries as props. Main e-commerce flow pages are localized.
